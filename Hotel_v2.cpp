...
Inmueble::Inmueble(Inmueble& original) {
	...
	my_strcpy(direccion, original.getDireccion());
	numCuartos = original.getNumCuartos();
	precio = original.getPrecio();
	my_strcpy(dniPropietario, original.getDniPropietario()); ///
}
...
void Inmueble::setDireccion(char* direccion) {
	...
	my_strcpy(this->direccion, direccion);
}

void Inmueble::setDniPropietario (char* dni) { ///
	my_strcpy(this->dniPropietario,dni);
}
...
Cliente::Cliente(Cliente &original) {
	...
	my_strcpy(nombre, original.getNombre());
	my_strcpy(dni, original.getDni());
	my_strcpy(telefono, original.getTelefono());
}
...
void Cliente::setNombre(char* nombre) {
	...
	my_strcpy(this->nombre, nombre);
}

void Cliente::setDni(char* dni) {
	my_strcpy(this->dni, dni);
}

void Cliente::setTelefono(char* telefono) {
	my_strcpy(this->telefono, telefono);
}
...
Propietario::Propietario(Propietario &original) {
	...
	my_strcpy(dni, original.getDni());
	my_strcpy(telefono, original.getTelefono());
	my_strcpy(contrasena, original.getContrasena());
}
...
void Propietario::setContrasena(char* contrasena) {
	...
	my_strcpy(this->contrasena, contrasena);
}
...
//Los que son propietarios son objetos de herencia 
